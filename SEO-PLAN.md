...
| **Контент** | ~430 товарів; **експертні картки 43/43 накладок** (Dignics, Tenergy, Sriver, Glayzer, Rozena, Feint, Tackiness, шипи/антиспін…) | — | Картки основ (Viscaria, Timo Boll ALC…); описи ракеток/екіпір.; наповнення «Столи» |
