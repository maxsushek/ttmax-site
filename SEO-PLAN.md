...
| **Контент** | ~430 товарів; **картки 43/43 накладок** + **5 пріоритетних основ** (Viscaria, Timo Boll ALC, Harimoto ALC, Apolonia ZLC, Timo Boll CAF) з таблицею класів ALC/ZLC/CAF | Решта основ (79/84) | Описи ракеток/екіпір.; наповнення «Столи» |
