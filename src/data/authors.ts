...
export const authors = {
  "artem-maksymchuk": {
    ...
    jobTitle: {
      ua: "Гравець настільного тенісу (КМС), тренер",
      ru: "Игрок настольного тенниса (КМС), тренер",
    },
    bio: {
      ua: "Гравець настільного тенісу (КМС) і тренер. Серед вихованок — чемпіонка України серед мінікадетів.",
      ru: "Игрок настольного тенниса (КМС) и тренер. Среди воспитанниц — чемпионка Украины среди микрокадетов.",
    },
    description: {
      ua: "Артем Максимчук — гравець настільного тенісу (КМС) і тренер із Харкова. Понад 140 зіграних турнірів. Серед вихованок — чемпіонка України серед мінікадетів. У статтях блогу TTMAX ділиться практичним досвідом гри та підбору інвентарю.",
      ru: "Артём Максимчук — игрок настольного тенниса (КМС) и тренер из Харькова. Более 140 сыгранных турниров. Среди воспитанниц — чемпионка Украины среди микрокадетов. В статьях блога TTMAX делится практическим опытом игры и подбора инвентаря.",
    },
