...
const GROUPS: Group[] = [
  {
    ...
    fields: [
      ...
      { key: CONTACT_KEYS.email, label: "Email", placeholder: "ttmax.ukraine@gmail.com" },
    ],
  },
  {
    ...
    fields: [
      {
        ...
        placeholder: "5000",
        hint: "Сума кошика, з якої доставка стає безкоштовною.",
      },
      {
        key: CONTACT_KEYS.shippingFee,
        label: "Нова Пошта, ₴",
        placeholder: "90",
        hint: "Тариф НП, якщо кошик менший за поріг. Зараз перевізник бере 90 ₴ за посилку до 2 кг.",
      },
      {
        key: CONTACT_KEYS.ukrposhtaFee,
        label: "Укрпошта, ₴",
        placeholder: "80",
        hint: "Тариф Укрпошти. З 01.04.2026 рахується за об'ємом: наші посилки — категорія «Малий» (80 ₴).",
      },
    ],
  },
];
